...
def get_bin_vals(num_bins: int) -> Array:
...
def poisson_process_log_likelihood(
    latent_function: Array, bin_area: float, flat_bin_counts: Array
) -> Array:
...
def get_latents_from_white(
    white: Array, const_mean: Union[float, f[Array, ""]], cholesky_gram: Array
) -> Array:
...
def get_white_from_latents(
    latents: Array, const_mean: Union[float, f[Array, ""]], cholesky_gram: Array
) -> Array:
